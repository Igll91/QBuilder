...
final class ValueChecker
{
    ...
    /**
     * Checks whether passed value is integer.
     *
     * @param $value mixed Value to be checked if it is valid integer.
     *
     * @throws \InvalidArgumentException If value is not valid integer.
     *
     * @return int Returns passed value or throws InvalidArgumentException.
     */
    ...
    public static function getPositiveIntOrEx($value)
    {
